...
export default function AdminConfiguration() {
  ...
  const saveFeature = async (e) => {
    ...
    try {
      const payload = { name, category: featureForm.category, is_active: featureForm.is_active }
                  ...
                  <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                      {featureLoading ? (
                        ...
                        <tr>
                          <td colSpan={3} className="px-6 py-8 text-slate-500 dark:text-slate-400">No key features found.</td>
                        </tr>
                      ) : (
