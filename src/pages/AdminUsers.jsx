  ...
  return (
    <AdminShell>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Manage staff accounts and roles</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 py-24">
        ...
        <h2 className="text-lg font-semibold text-slate-700 dark:text-slate-200">User Management</h2>
